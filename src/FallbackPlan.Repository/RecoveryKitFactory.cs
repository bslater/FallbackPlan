...
public static class RecoveryKitFactory
{
        ...
        ulong issuedAt)
    {
        ...
        return new RecoveryKit
        {
            ...
            RepositoryId = null,
            RepositoryFormatVersion = Domain.FormatLimits.FormatVersion,
    ...
    /// <remarks>
    /// The kit carries no key material at all (ADR-0042 §8): the sealing
    /// public key rides as the verifier, the key-object field is empty, and
    /// the passphrase is still proven before export — by derive-and-compare —
    /// so a kit is never exported that the passphrase cannot use.
    /// </remarks>
        ...
        CancellationToken cancellationToken)
    {
        ...
        return new RecoveryKit
        {
            ...
            SealingPublicKey = descriptor.SealingPublicKey,
        };
    }
}
