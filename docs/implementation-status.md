...
| [0047](adr/0047-backup-pool-and-priorities.md) | The backup pool: concurrency, priorities, a pass that never waits for transfers | Built | `Agent/JobScheduler` · `Agent/Scheduler` · `Application/ClientConfiguration` (schema 5) · `Application/DestinationSyncStore` (schema 2) · `Hosts.Tests/JobSchedulerPoolTests`, `Hosts.Tests/SchedulerStarvationTests`, `Hosts.Tests/ConfigurationCommandTests`, `Application.Tests/DestinationSyncStoreTests` |
