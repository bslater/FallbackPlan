# ADR-0072 — Snapshot-based capture: a privileged helper, and what each platform is actually promised
...
| 2026-09 | Proposed | Renumbered from ADR-0048 in the merge that brought this line together with the branch, which had already assigned 0048 to a different decision. The decision itself is unchanged and arrives whole: nothing on the branch overlaps it. |
