# ADR-0073 — A browser suite for the console
...
| 2026-09 | Accepted | Renumbered from ADR-0049 in the merge that brought this line together with the branch, which had already assigned 0049 to a different decision. The decision itself is unchanged and arrives whole, with its suite. |
