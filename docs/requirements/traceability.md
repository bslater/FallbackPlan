...
| NFR-REL-001, 005 | [04 §5.1](../architecture/04-concurrency-and-publication.md#51-interruption-at-each-step) | — | `InterruptionTests/BlobSpoolResumeTests`, `InterruptionTests/PublicationInterruptionTests`, `InterruptionTests/SequenceRollbackTests`, `InterruptionTests/SessionDisposalTests`, `InterruptionTests/SpoolHygieneTests`, `InterruptionTests/StoreFaultTests`, `InterruptionTests/VoidObligationTests`, `Repository.FuzzTests/ParserFuzzTests` | 0 |
