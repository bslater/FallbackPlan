...
That marker is a statement about *traceable* coverage, not proof of its absence: a test may exercise a requirement without citing its ID, and it will read as untested here until it does. Citing the ID is the cheaper half of the fix, and the honest direction of travel is to add the citation rather than to soften the column.
...
| FR-ARCH-002 | [02 §3.4](../architecture/02-repository-format.md#34-capture-algorithm) | — | — *(untested; phase 0)* | 0 |
...
| ID | Arch | ADR | Test | Phase |
|----|------|-----|------|-------|
| FR-MAN-001 | [02 §6](../architecture/02-repository-format.md#6-manifests) | — | — *(untested; phase 0)* | 0 |
...
| FR-MAN-004 | [02 §6.3](../architecture/02-repository-format.md#63-sharding-and-encoding) | [0003](../adr/0003-canonical-metadata-encoding.md) | — *(untested; phase 1)* | 1 |
| FR-MAN-005 | [02 §8](../architecture/02-repository-format.md#8-catalogue-rebuild) | — | `Repository.Tests/CatalogueTests` | 1 |
| FR-MAN-006 | [03 §5](../architecture/03-crypto.md#5-deduplication-trust-domains) | [0006](../adr/0006-object-identifiers-and-dedup-trust-domains.md) | — *(untested; phase 0)* | 0 |
...
| FR-MAN-010 | [02 §8.2](../architecture/02-repository-format.md#82-forensic-rebuild) | — | — *(untested; phase 1)* | 1 |
| FR-MAN-011 | [02 §8.2](../architecture/02-repository-format.md#82-forensic-rebuild) | — | `InterruptionTests/CorruptionHarnessTests` | 0 |
| FR-MAN-012 | [02 §8.3](../architecture/02-repository-format.md#83-rebuild-never-repairs) | — | — *(untested; phase 1)* | 1 |
| FR-MAN-014 | [02 §8.3](../architecture/02-repository-format.md#83-rebuild-never-repairs) | — | — *(untested; phase 0)* | 0 |
...
| FR-DED-002 | [03 §5.2](../architecture/03-crypto.md#52-the-domains) | [0006](../adr/0006-object-identifiers-and-dedup-trust-domains.md) | — *(untested; phase 0)* | 0 |
...
| FR-SNP-002 | [01 §5](../architecture/01-domain-model.md#5-replication-not-synchronisation) | — | — *(untested; phase 1)* | 1 |
...
| FR-SNP-004 | [04 §4](../architecture/04-concurrency-and-publication.md#4-write-intent) | [0009](../adr/0009-garbage-collection-safety.md) | — *(untested; phase 0)* | 0 |
...
| ID | Arch | ADR | Test | Phase |
|----|------|-----|------|-------|
| FR-RST-001 | [08 §1](../architecture/08-restore-and-recovery.md#1-restore-paths) | — | — *(untested; phase 1)* | 1 |
...
| FR-RST-003 | [08 §2](../architecture/08-restore-and-recovery.md#2-restore-planning) | — | — *(untested; phase 1)* | 1 |
...
| FR-RST-006 | [08 §3.1](../architecture/08-restore-and-recovery.md#31-quarantine-by-default) | — | — *(untested; phase 1)* | 1 |
...
| ID | Arch | ADR | Test | Phase |
|----|------|-----|------|-------|
| FR-SVC-001..008 | [00 §6.1](../architecture/00-overview.md#61-process-model), [04 §9](../architecture/04-concurrency-and-publication.md#9-two-different-concurrencies-and-why-conflating-them-is-dangerous), [11 §2](../architecture/11-solution-structure.md#2-dependency-rules) | [0028](../adr/0028-service-boundary-and-deployment-topologies.md) | `Api.Tests/ContractVersionTests`, `Api.Tests/LocalBindingTests`, `Application.Tests/StateDirectoryLockTests` | 2 |
...
| NFR-PERF-005 | [02 §6.3](../architecture/02-repository-format.md#63-sharding-and-encoding) | — | — *(untested; phase 1)* | 1 |
...
| NFR-PERF-007 | [02 §3](../architecture/02-repository-format.md#3-segmentation) | [0002](../adr/0002-segmentation-strategy.md), [0029](../adr/0029-pipeline-and-service-concurrency.md) | — *(untested; phase 1)* | 1 |
...
| NFR-PERF-014 | [02 §7.1](../architecture/02-repository-format.md#71-structure) | [0007](../adr/0007-logical-object-identifiers-in-manifests.md) | — *(untested; phase 0)* | 0 |
| NFR-PERF-013 | [10 §2](../architecture/10-observability.md#2-technical-metrics) | — | — *(untested; phase 1)* | 1 |
...
| NFR-REL-002, 007 | [11 §3](../architecture/11-solution-structure.md#3-local-state-separation) | [0010](../adr/0010-local-store-separation.md) | — *(untested; phase 1)* | 1 |
| NFR-REL-003, 006 | [02 §8](../architecture/02-repository-format.md#8-catalogue-rebuild) | — | — *(untested; phase 0)* | 0 |
...
| NFR-SEC-002 | [03 §2](../architecture/03-crypto.md#2-key-hierarchy) | [0005](../adr/0005-aead-suite-and-nonce-construction.md) | — *(untested; phase 0)* | 0 |
...
| NFR-SEC-005 | [03 §6](../architecture/03-crypto.md#6-authentication-of-repository-state) | [0008](../adr/0008-index-generations-and-checkpoints.md) | — *(untested; phase 1)* | 1 |
| NFR-SEC-006 | [10 §4](../architecture/10-observability.md#4-diagnostics) | — | — *(untested; phase 1)* | 1 |
...
| NFR-COMP-007 | — | [0014](../adr/0014-format-versioning-and-stability.md) | — *(untested; phase 0)* | 0 |
...
| NFR-PORT-002 | [11 §2](../architecture/11-solution-structure.md#2-dependency-rules) | — | — *(untested; phase 0)* | 0 |
