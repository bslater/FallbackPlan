...
Azure, S3, retention pruning, and CrashPlan conversion layer on only after both are reliable. This ordering makes recoverability — not feature count — the foundation.
